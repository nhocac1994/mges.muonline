    ...
    <div className="min-h-screen relative overflow-hidden mu-retro-bg-texture" style={{
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl mu-retro-title mb-4">TẢI GAME</h1>
          <p className="text-xl mu-text-gold">{siteConfig.serverName} - Client và Launcher</p>
        </div>
      </section>
          ...
          <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto">
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="text-center mu-retro-card" style={{ padding: '56px 56px 56px 56px', paddingTop: '20px' }}>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-14">
            <h2 className="text-5xl mu-retro-title mb-4">YÊU CẦU HỆ THỐNG</h2>
            <p className="text-xl text-gray-300">Thông tin cấu hình máy tính cần thiết</p>
          </div>
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8">
              <div className="mu-retro-card text-center" style={{ padding: '56px 56px 56px 56px', paddingTop: '20px' }}>
                <div className="relative z-10">
                  <h3 className="text-2xl mu-retro-title-small mb-8">Tối Thiểu</h3>
                  <div className="space-y-5" style={{ marginTop: '60px' }}>
                    <div className="flex justify-between">
                      <span className="text-gray-300 text-lg">OS:</span>
                      <span className="text-white text-lg">Windows 7/8/10/11</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-300 text-lg">CPU:</span>
                      <span className="text-white text-lg">Intel Core 2 Duo</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-300 text-lg">RAM:</span>
                      <span className="text-white text-lg">2 GB</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-300 text-lg">GPU:</span>
                      <span className="text-white text-lg">DirectX 9.0c</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-300 text-lg">Storage:</span>
                      <span className="text-white text-lg">5 GB</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="mu-retro-card text-center" style={{ padding: '56px 56px 56px 56px', paddingTop: '20px' }}>
                <div className="relative z-10">
                  <h3 className="text-2xl mu-retro-title-small mb-4">Khuyến Nghị</h3>
                  <div className="space-y-5" style={{ marginTop: '60px' }}>
                    <div className="flex justify-between">
                      <span className="text-gray-300 text-lg">OS:</span>
                      <span className="text-white text-lg">Windows 10/11</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-300 text-lg">CPU:</span>
                      <span className="text-white text-lg">Intel Core i5</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-300 text-lg">RAM:</span>
                      <span className="text-white text-lg">8 GB</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-300 text-lg">GPU:</span>
                      <span className="text-white text-lg">DirectX 11</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-300 text-lg">Storage:</span>
                      <span className="text-white text-lg">10 GB SSD</span>
                    </div>
                  </div>
                </div>
              </div>
